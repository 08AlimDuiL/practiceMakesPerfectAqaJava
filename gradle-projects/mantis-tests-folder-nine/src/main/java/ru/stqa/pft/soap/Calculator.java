 ...
 * 2025-11-25T13:50:00.087+03:00
 * Generated source version: 4.0.3
 *
 */
@WebServiceClient(name = "Calculator",
                  wsdlLocation = "file:src/main/resources/calculator.wsdl",
...
public class Calculator extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:src/main/resources/calculator.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Calculator.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:src/main/resources/calculator.wsdl");
        }
        WSDL_LOCATION = url;
    }
