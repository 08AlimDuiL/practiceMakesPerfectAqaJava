...
public class JamesHelperOldWithTelnet
{
    ...
    public JamesHelperOldWithTelnet(ApplicationManager app) {
        this.app = app;
    ...
    public void deleteUser(String name) {
        initTelnetSession();
        write("deluser " + name);
        String result = readUntil("deleted");
        closeTelnetSession();
    }
